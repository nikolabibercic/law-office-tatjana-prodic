...
<head>
    ...
    <title>Advokat Tatjana Prodić</title>
</head>
<body>
    ...
    <header>
        ...
        <hgroup>
            <h1>Advokat Novi Sad</h1>
            <p>Višegodišnje iskustvo u različitim oblasima prava</p>
            <a href="index.php#contactFormId"><button>Kontaktirajte nas</button></a>
        </hgroup>
    </header>